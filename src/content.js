...
// taken verbatim from src/NuGetGallery/Scripts/gallery/common.js
var copyTextToClipboard = function (text, elementToFocus) {
  if (detectIE()) {
    try {
...
// taken verbatim from src/NuGetGallery/Scripts/gallery/page-display-package.js
var configureCopyButton = function (id) {
